...
ann_file_train = 'data/ds_taichi/TEST7AUG8/NSNR/train_data.pkl'
ann_file_val = 'data/ds_taichi/TEST7AUG8/NSNR/test_data.pkl'
left = [
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type='PoseDataset',
            ann_file='data/ds_taichi/TEST7AUG8/NSNR/train_data.pkl',
            data_prefix='',
            pipeline=[
                dict(type='UniformSampleFrames', clip_len=48),
                dict(type='PoseDecode'),
    ...
    val=dict(
        type='PoseDataset',
        ann_file='data/ds_taichi/TEST7AUG8/NSNR/test_data.pkl',
        data_prefix='',
        pipeline=[
            dict(
...
output_config = dict(
    out='./model_pth/exp3/NSNR-linear5-T7A8/test_result/results.pkl')
eval_config = dict(
    metric_out='./model_pth/exp3/NSNR-linear5-T7A8/test_result',
    eval=[
...
log_level = 'INFO'
work_dir = './model_pth/exp3/NSNR-linear5-T7A8'
