...
output_config = dict(
    out='./model_pth/exp3/NSNR-linear5-T9A2/test_result/results.pkl')
eval_config = dict(
    metric_out='./model_pth/exp3/NSNR-linear5-T9A2/test_result',
    eval=[
...
log_level = 'INFO'
work_dir = './model_pth/exp3/NSNR-linear5-T9A2'
