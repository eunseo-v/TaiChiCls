...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type='PoseDataset',
            ann_file='data/ds_taichi/TEST9AUG8/NSNR/train_data.pkl',
            data_prefix='',
            pipeline=[
                dict(type='UniformSampleFrames', clip_len=48),
                dict(type='PoseDecode'),
    ...
    val=dict(
        type='PoseDataset',
        ann_file='data/ds_taichi/TEST9AUG8/NSNR/test_data.pkl',
        data_prefix='',
        pipeline=[
            dict(
...
optimizer = dict(type='SGD', lr=0.6, momentum=0.9, weight_decay=0.0003)
