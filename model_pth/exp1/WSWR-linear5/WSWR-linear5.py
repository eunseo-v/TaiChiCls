...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type='PoseDataset',
            ann_file='data/ds_taichi/TEST9AUG4/WSWR/train_data.pkl',
            data_prefix='',
            pipeline=[
                dict(type='UniformSampleFrames', clip_len=48),
                dict(type='PoseDecode'),
    ...
    val=dict(
        type='PoseDataset',
        ann_file='data/ds_taichi/TEST9AUG4/WSWR/test_data.pkl',
        data_prefix='',
        pipeline=[
            dict(
...
output_config = dict(
    out='./model_pth/exp1-new/WSWR-linear5/test_result/results.pkl')
eval_config = dict(
    metric_out='./model_pth/exp1-new/WSWR-linear5/test_result',
    eval=[
...
log_level = 'INFO'
work_dir = './model_pth/exp1-new/WSWR-linear5'
