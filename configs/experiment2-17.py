...
'''
output_config = dict(
    out = './model_pth/17part_ntu60_xsub_kp_0401/test_result/results.pkl'
)
eval_config = dict(
    metric_out = './model_pth/17part_ntu60_xsub_kp_0401/test_result',
    eval = ['top_k_accuracy', 'mean_class_accuracy', 'confusion_matrix'],
) # train中不写test_last test_best 在test.py中测试
dist_params = dict(backend='nccl')
log_level = 'INFO'
work_dir = './model_pth/17part_ntu60_xsub_kp_0401'
load_from = None
resume_from = None
