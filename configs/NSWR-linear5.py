...
ann_file_train = 'data/ds_taichi/TEST7AUG4/NSWR/train_data.pkl'
ann_file_val = 'data/ds_taichi/TEST7AUG4/NSWR/test_data.pkl'
left = [
...
'''
output_config = dict(
    out = './model_pth/NSWR-linear5_xsub_kp_0409/test_result/results.pkl'
)
eval_config = dict(
...
log_level = 'INFO'
work_dir = './model_pth/NSWR-linear5_xsub_kp_0409'
