...
ann_file_train = 'data/ds_taichi/TEST7AUG4/WSNR/train_data.pkl'
ann_file_val = 'data/ds_taichi/TEST7AUG4/WSNR/test_data.pkl'
left = [
...
'''
output_config = dict(
    out = './model_pth/WSNR-linear5_xsub_kp_0409/test_result/results.pkl'
)
eval_config = dict(
...
log_level = 'INFO'
work_dir = './model_pth/WSNR-linear5_xsub_kp_0409'
